...
<svg xmlns="http://www.w3.org/2000/svg" {width} {height} viewBox="0 0 32 32" {...$$props}>
	<g fill="none">
		...
		<path
			...
			d="M15.999 29.998c9.334 0 13.999-6.268 13.999-14c0-7.73-4.665-13.998-14-13.998C6.665 2 2 8.268 2 15.999c0 7.731 4.664 13.999 13.999 13.999"
		/>
		<circle cx="9.017" cy="13.421" r="4.673" fill="url(#f1424id8)" />
		<circle cx="19.244" cy="13.943" r="4.244" fill="url(#f1424id9)" />
		<path
			fill="#fff"
		...
		/>
		<path fill="url(#f1424ida)" d="M11 15a3 3 0 1 0 0-6a3 3 0 0 0 0 6" />
		<path fill="url(#f1424idb)" d="M21 15a3 3 0 1 0 0-6a3 3 0 0 0 0 6" />
		<path
			fill="url(#f1424idc)"
			fill-rule="evenodd"
			d="M10 20a1 1 0 0 1 1-1h10a1 1 0 1 1 0 2H11a1 1 0 0 1-1-1"
			clip-rule="evenodd"
		/>
		<defs>
			<radialGradient
