...
<svg xmlns="http://www.w3.org/2000/svg" {width} {height} viewBox="0 0 32 32" {...$$props}>
	<g fill="none">
		...
		<path
			...
			d="M15.999 29.998c9.334 0 13.999-6.268 13.999-14c0-7.73-4.665-13.998-14-13.998C6.665 2 2 8.268 2 15.999c0 7.731 4.664 13.999 13.999 13.999"
		/>
		<circle cx="9.017" cy="13.421" r="4.673" fill="url(#f580id8)" />
		<circle cx="19.244" cy="13.943" r="4.244" fill="url(#f580id9)" />
		<path
			fill="#fff"
		...
		/>
		<path fill="url(#f580ida)" d="M11 15a3 3 0 1 0 0-6a3 3 0 0 0 0 6" />
		<path fill="url(#f580idb)" d="M21 15a3 3 0 1 0 0-6a3 3 0 0 0 0 6" />
		<path
			stroke="url(#f580idc)"
			stroke-linecap="round"
			stroke-width="2"
			d="M10 22c.333-.667 2-3 6-3s5.667 2.333 6 3"
		/>
		<defs>
			<radialGradient
				id="f580id0"
			...
			<radialGradient
				...
				cy="0"
				r="1"
				gradientTransform="rotate(135 4.3 7.513)scale(9.10579 4.71285)"
				gradientUnits="userSpaceOnUse"
			>
			...
			<radialGradient
				...
				cy="0"
				r="1"
				gradientTransform="rotate(135 9.069 9.99)scale(7.66968 4.32966)"
				gradientUnits="userSpaceOnUse"
			>
				<stop stop-color="#392108" />
				<stop offset="1" stop-color="#c87928" stop-opacity="0" />
			...
			<linearGradient id="f580idc" x1="16" x2="16" y1="18" y2="20" gradientUnits="userSpaceOnUse">
